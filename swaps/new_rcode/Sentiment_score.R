...
# neg = scan('/home/purva/Desktop/project/negative-words.txt', what='character', comment.char=';')
 pos = scan('/home/raghuvarma/Documents/Social_Media_Demo/Word_Files/positive-words.txt', what='character', comment.char=';')
 neg = scan('/home/raghuvarma/Documents/Social_Media_Demo/Word_Files/negative-words.txt', what='character', comment.char=';')
