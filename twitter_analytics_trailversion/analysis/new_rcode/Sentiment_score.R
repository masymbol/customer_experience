...
logistic <- function(ans,str)
{
 ...
 tweets <- read.csv(ss_t,stringsAsFactors=FALSE, fileEncoding="latin1")
 post <- read.csv(ss_gp,stringsAsFactors=FALSE, fileEncoding="latin1")
...
# neg = scan('/home/purva/Desktop/project/negative-words.txt', what='character', comment.char=';')
 pos = scan('../../../../analysis/project/positive-words.txt', what='character', comment.char=';')
 neg = scan('../../../../analysis/project/negative-words.txt', what='character', comment.char=';')
